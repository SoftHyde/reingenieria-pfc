		...
		<div class="col-md-8 col-md-offset-2">	
            ...
            <form role="form" method="POST" enctype="multipart/form-data" action="{{ route('project.store') }}">
                ...
                <table class="table table-bordered" id="dynamicAddRemove">
                    ...
                    <tr>
                        <td><input type="text" name="tag[0][tag]" placeholder="Ingrese el tag" class="form-control" value="{{ old('project_tag') }}"/>
                        </td>
...
<script type="text/javascript">
    ...
    $("#dynamic-ar").click(function () {
        ...
        $("#dynamicAddRemove").append('<tr><td><input type="text" name="tag[' + i +
            '][tag]" placeholder="Enter tag" class="form-control" /></td><td><button type="button" class="btn btn-outline-danger remove-input-field">Delete</button></td></tr>'
            );
    });
